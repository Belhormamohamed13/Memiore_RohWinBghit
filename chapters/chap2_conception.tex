...
Le recueil des besoins s'est articulé autour de trois axes :
\begin{itemize}
  \item \textbf{Enquête utilisateurs :} Un questionnaire (questionnaire en ligne, mars 2026, diffusé via les réseaux sociaux universitaires de Tlemcen et Oran) auprès de 150 personnes a identifié les attentes prioritaires (sécurité, prix, disponibilité).
  \item \textbf{Étude comparative :} Décomposition fonctionnelle des plateformes concurrentes pour dégager les manques structurels du marché algérien.
  \item \textbf{Entretiens semi-directifs :} Consultations ciblées avec des conducteurs habitués aux longs trajets.
\end{itemize}
