...
\hline
\texttt{Admin} & admin\_level & moderateReview(), reviewKyc() \\
\hline
...
\hline
from\_wilaya\_id & \texttt{INTEGER} & FK $\to$ wilayas, NOT NULL & Wilaya de départ \\
\hline
to\_wilaya\_id & \texttt{INTEGER} & FK $\to$ wilayas, NOT NULL & Wilaya d'arrivée \\
\hline
