...
Les limites structurelles identifiées au Chapitre~I appellent une spécification rigoureuse des exigences puis une conception architecturale adaptée. Le présent chapitre commence par formaliser les exigences fonctionnelles et non fonctionnelles du système (section~2.2), puis modélise les besoins en notation UML (section~2.3). Il détaille ensuite la méthodologie de développement retenue (section~2.4), l'architecture logique multi-services (section~2.5), la modélisation mathématique du pipeline biométrique KYC (section~2.6), les processus métiers en notation BPMN (section~2.7) et enfin la modélisation statique du domaine (section~2.8). L'ensemble de la conception s'appuie sur les modélisations UML 2.5~\cite{fowler_uml_2003} et sur les processus métiers BPMN 2.0.
...
Ce chapitre a formalisé la spécification des exigences fonctionnelles et non fonctionnelles du système (section~2.2) et modélisé les besoins en notation UML~2.5 (section~2.3). Il a ensuite présenté les choix méthodologiques et la conception de la solution logicielle. Après avoir détaillé le déroulement des sprints Scrum (section~2.4), nous avons exposé la conception de l'architecture multi-services découplée (section~2.5). La dimension de sécurité et de confiance a été modélisée mathématiquement à travers le pipeline de décision biométrique KYC (section~2.6). Les flux opérationnels de la plateforme ont été décrits en notation BPMN 2.0 (section~2.7) et la structure conceptuelle a été formalisée par le diagramme de classes logiques du domaine (section~2.8). Le chapitre suivant détaille la réalisation technique, la campagne de tests Jest et l'évaluation d'utilisabilité quantitative.
