...
\begin{bmcblock}[height=8.8cm]{\faHandshake~Partenaires Clés}%
\scriptsize
...
\end{itemize}
\end{bmcblock} &%
\begin{bmcblock}[height=4.2cm]{\faCogs~Activités Clés}%
\scriptsize
...
\end{bmcblock}%
\vspace{0.4cm}%
\begin{bmcblock}[height=4.2cm]{\faLaptop~Ressources Clés}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{itemize}
\end{bmcblock} &%
\begin{bmchighlight}[height=8.8cm]{\faGem~Proposition de Valeur}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=4pt, parsep=0pt]
...
\end{itemize}
\end{bmchighlight} &%
\begin{bmcblock}[height=4.2cm]{\faHeart~Relations Clients}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{bmcblock}%
\vspace{0.4cm}%
\begin{bmcblock}[height=4.2cm]{\faBullhorn~Canaux}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{itemize}
\end{bmcblock} &%
\begin{bmcblock}[height=8.8cm]{\faUsers~Segments Clients}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=4pt, parsep=0pt]
...
\begin{bmcblock}[height=3.4cm]{\faCoins~Structure de Coûts}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{itemize}
\end{bmcblock} &%
\begin{bmcblock}[height=3.4cm]{\faMoneyBillWave~Sources de Revenus}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
