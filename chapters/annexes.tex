...
\small
\begin{itemize}[leftmargin=1.2em, nosep]
  \item Investissements initiaux (1,79 M DZD)
  \item Charges salariales et loyer de bureau
  \item Hébergement web et consommation d'API
  \item Budget marketing digital et acquisition
\end{itemize} &

\small
\begin{itemize}[leftmargin=1.2em, nosep]
  \item Commissions transactionnelles (12\,\% sur les trajets)
  \item Abonnements Premium (1 500 DZD/mois par conducteur)
  \item Publicité in-app ciblée
\end{itemize} \\[6pt]
