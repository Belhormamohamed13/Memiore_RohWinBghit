...
\end{itemize}
\end{bmcblock} &%
\begin{bmcblock}[height=3.7cm]{\faCogs~Activités Clés}%
\scriptsize
...
\end{bmcblock}%
\vspace{0.3cm}%
\begin{bmcblock}[height=4.8cm]{\faLaptop~Ressources Clés}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{itemize}
\end{bmchighlight} &%
\begin{bmcblock}[height=3.7cm]{\faHeart~Relations Clients}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
...
\end{bmcblock}%
\vspace{0.3cm}%
\begin{bmcblock}[height=4.8cm]{\faBullhorn~Canaux}%
\scriptsize
\begin{itemize}[leftmargin=1.0em, itemsep=2pt, parsep=0pt]
