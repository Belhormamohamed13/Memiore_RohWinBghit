...
\textcolor{rohblue}{\faGem\ \textbf{Propositions de Valeur}} &
\textcolor{rohblue}{\faHeart\ \textbf{Relation Client}} &
\textcolor{rohblue}{\faUsers\ \textbf{Segments Clients}} \\[4pt]
...
\begin{itemize}[leftmargin=1em, nosep]
  ...
  \item Sécurité (biométrie)
  \item Coûts partagés
  \item Réservation digitale
\end{itemize}
\end{tabular}
} &
...
& \vspace{2pt} \hrule \vspace{2pt} \textcolor{rohblue}{\faCubes\ \textbf{Ressources Clés}} & & \vspace{2pt} \hrule \vspace{2pt} \textcolor{rohblue}{\faBullhorn\ \textbf{Canaux}} & \\
...
\begin{tabularx}{\linewidth}{@{}
  ...
  >{\hsize=1.0\hsize\raggedright\arraybackslash}X
@{}}
\textcolor{rohblue}{\faCoins\ \textbf{Structure de Coûts}} &
\textcolor{rohblue}{\faCreditCard\ \textbf{Sources de Revenus}} \\[4pt]

\scriptsize
\begin{itemize}[leftmargin=1em, nosep]
  \item Investissements initiaux (1,79 M DZD)
  \item Charges salariales et loyer
  \item Hébergement web et API
  \item Budget marketing digital
\end{itemize} &

\scriptsize
\begin{itemize}[leftmargin=1em, nosep]
  \item Commission (12\,\% sur les trajets)
  \item Abonnements Premium (1 500 DZD/mois)
