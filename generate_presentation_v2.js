...
// =============================================================================
{
    ...
    const metrics = [
        ...
        { title: "Qualité", detail: "373/373 tests Jest 100%" }
    ];
...
// =============================================================================
{
    ...
    const contributions = [
        ...
        { title: "Validation Empirique", desc: "100% de réussite sur la suite de tests Jest automatisés (373/373) et score SUS de 71.6/100 validant la fluidité de l'expérience utilisateur." }
    ];
