...
\externaldocument{annexes_standalone}
...
% Redéfinition complète de la page d'ouverture de chapitre
\titleformat{\chapter}[display]
  {\normalfont\color{rohblue}}
  {}
  {0pt}
  {%
    \thispagestyle{empty}%
    ...
    \begin{center}
      ...
      % Numéro du chapitre
      {\fontsize{16}{20}\selectfont\scshape
       \chaptertitlename~\thechapter}\\[1em]
      % Filet séparateur
      \rule{0.4\textwidth}{0.6pt}\\[1.5em]
      % Titre du chapitre (grand, gras)
      {\fontsize{22}{28}\selectfont\bfseries #1}\\[1.5em]
...
% Supprimer l'espace vertical par défaut avant le titre
\titlespacing*{\chapter}{0pt}{0pt}{0pt}

% Style normal pour les chapitres non numérotés standard (Remerciements, Dédicaces, Résumés, TOC...)
\titleformat{name=\chapter,numberless}[block]
  {\normalfont\color{rohblue}\Huge\bfseries}
  {}
  {0pt}
  {#1}
\titlespacing*{name=\chapter,numberless}{0pt}{10pt}{20pt}

% Patch pour que le contenu commence page suivante
\patchcmd{\chapter}
  {\if@openright\cleardoublepage\else\clearpage\fi}
  {\if@openright\cleardoublepage\else\clearpage\fi}
  {}{}

% Commande personnalisée pour chapitres étoilés
...
% Style plain = pages de chapitre, TDM, etc.
...
% ==================== PAGES FINALES ====================
\chapterstar{Bibliographie et webographie}
